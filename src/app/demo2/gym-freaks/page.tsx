...
export default function GymFreaksPage() {
  ...
  const products = allProducts.filter(p => p.category === 'Gym Freaks');
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-200 text-xl md:text-2xl max-w-3xl mx-auto font-semibold leading-relaxed">
              Performance meets streetwear aesthetic. Built for those who push limits and break barriers.
            </p>
          </div>
        </div>
      </section>
