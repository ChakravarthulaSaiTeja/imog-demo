...
export default function HackersPage() {
  ...
  const products = allProducts.filter(p => p.category === 'Hackers');
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-200 text-xl md:text-2xl max-w-3xl mx-auto font-semibold leading-relaxed">
              Tech-forward gear for the digital underground. Built for those who live in terminals and think in code.
            </p>
          </div>
        </div>
      </section>
