...
export default function PartyPeoplePage() {
  ...
  const products = allProducts.filter(p => p.category === 'Party People');
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-200 text-xl md:text-2xl max-w-3xl mx-auto font-semibold leading-relaxed">
              Bold statement pieces for nightlife. Stand out when the lights go down and the energy goes up.
            </p>
          </div>
        </div>
      </section>
