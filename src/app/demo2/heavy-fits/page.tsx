...
export default function HeavyFitsPage() {
  // Get products from centralized data to ensure slugs are available
  const products = allProducts.filter(p => p.category === 'Heavy Fits');
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-200 text-xl md:text-2xl max-w-3xl mx-auto font-semibold leading-relaxed">
              Oversized comfort for maximum impact. When you want to feel weightless but look heavy.
            </p>
          </div>
        </div>
      </section>
